...
public partial class Admin_PrintDeliveryInvoice : System.Web.UI.Page
{
    ...
    public void PrintData()
    {
        using (SqlConnection conn = new SqlConnection(Connstr))
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("select d.Customer_Name,d.Cust_Address,d.Mobile_no,d.Dc_Date,d.DC_No,d.Total_Qty,d.Total_Qty,i.Remark from dbo.tblDeliveryChallan d inner join tblIDeliveryIncome i on i.Dc_No=d.DC_No where d.DC_No=@DC_No", conn);
            ...
            SqlCommand cmdGrid = new SqlCommand("select i.Product_Name,i.Product_Qty,i.Remark from dbo.tblDeliveryChallan d inner join tblIDeliveryIncome i on i.Dc_No=d.DC_No  where d.DC_No=@DC_No", conn);
