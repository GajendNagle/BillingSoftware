<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="PrintDeliveryInvoice.aspx.cs" Inherits="Admin_PrintDeliveryInvoice" %>
    ...
    <table style="border: 1px solid #000; background-color: #fff; height: auto; width: 62%; margin: 20px auto; font-family: Arial, sans-serif; border-collapse: collapse;">
        <tr>
            <td colspan="3" style="text-align: center; font-size: 15px;">
                <h4 class="text-capitalize" style="text-decoration: underline; display: inline;">Delivery Challan</h4>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="text-align: center; font-size: 24px;">
                <b><asp:Label runat="server" ID="lblCompanyName"></asp:Label></b>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" style="text-align: center; font-size: 18px;">
                Phone: <asp:Label Style="text-align: center; font-size: 16px;" runat="server" ID="lblCompanyMobile"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="padding: 10px; width: 65%; border: 1px solid #000; vertical-align: top; text-align: left;">
                <strong>Name:</strong> <asp:Label ID="lblCustomerName" runat="server" Style="font-size: 16px;"></asp:Label><br />
                <strong>Mobile:</strong> <asp:Label ID="lblMobileNumber" runat="server" Style="font-size: 16px;"></asp:Label><br>
                <strong>Address:</strong> <asp:Label ID="lblCustAddress" runat="server" Style="font-size: 16px;"></asp:Label>
            </td>
            <td style="padding: 10px; width: 35%; border-top: 1px solid; border-bottom: 1px solid #000; vertical-align: top; text-align: left;">
                <strong>DC No:</strong> <asp:Label ID="lblOrderNo" runat="server" Style="font-size: 16px;"></asp:Label><br>
                <strong>Date:</strong> <asp:Label ID="lblOrderDate" runat="server" Style="font-size: 16px;"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <asp:DataList ID="grdPrint" runat="server" RepeatDirection="Vertical" Style="width: 100%;">
                    <HeaderTemplate>
                        <tr>
                            ...
                            <th style="border-left: 1px solid black; padding: 8px; text-align: left;">Remark</th>
                        </tr>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="border-bottom: 1px solid black; border-top: 1px solid black; padding: 8px; text-align: left;">
                                <asp:Label ID="lblAmount" runat="server" Text='<%# Eval("Remark") %>'></asp:Label>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:DataList>
       ...
       <%-- <tr>
            <td colspan="2" style="text-align: left; font-size: 13px; font-weight: bold;">Total Qty: 
...
<asp:Label ID="lbltotalQty" runat="server" Text="0.00"></asp:Label>
   ...
   <tr>
    ...
    <div class="footer" style="margin-top: 20px; text-align: center;">
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-success " Text="Print" />
    </div>
